...
export const translations: {
  ...
  tr: {
    ...
    english: 'İngilizce',
    notFound: 'Bulunamadı',
    pageNotFound: 'Üzgünüz! Aradığınız sayfa mevcut değil.',
    ...
    noNotes: 'Bu gün için not yok',
    allNotesFor: 'Tüm Notlar',
    currentHour: 'Şu an - Not yok',
    ...
    welcomeNote: 'Takvim Notlarına Hoş Geldiniz! Başlamak için bir not ekleyin.',
    ...
    clickAddNote: 'Not eklemek için tıklayın',
    work: 'iş',
    personal: 'kişisel',
    important: 'önemli',
    meeting: 'toplantı',
    ...
    confirm: 'Onayla',
    deleteNotePrompt: 'Bu notu silmek istediğinizden emin misiniz?',
